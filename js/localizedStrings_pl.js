...
LocalizedStrings_pl.set("free_time_projects", "Inne projekty")
...
LocalizedStrings_pl.set("modal_learned", "Czego się nauczyłem")

/* Cafe Template */
LocalizedStrings_pl.set("cafe_title", "Szablon strony Cafe")
LocalizedStrings_pl.set("cafe_description", "Szablon strony kawiarni stworzony przy użyciu <strong>ASP.NET Core 5</strong> jako backend i <strong>SQLite</strong>. Strona zbudowana z myślą o <strong>urządzeniach mobilnych</strong>.")
...
LocalizedStrings_pl.set("ecs_learned", "Dobre zrozumienie JavaScript'owego <strong>Event Loop</strong>, jak przetwarzać złożone <strong>dane wejścia</strong> i <strong>instrukcje renderowania</strong> (frame independent animations, kolizje AABB, itd).")